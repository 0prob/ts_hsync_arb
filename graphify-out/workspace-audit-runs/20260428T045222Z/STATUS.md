...
- PASS `path`: [createWarmupManager() to boot_mode.ts](path_createwarmupmanager_to_boot_mode_ts.md)
...
- PASS `explain`: [createWarmupManager()](explain_createwarmupmanager.md)
...
- Outputs: `graphify-out/workspace-audit-runs/20260428T045222Z`
- Scope: `graphify-out/workspace-audit-runs/20260428T045222Z/SCOPE.md`
- Commands: `graphify-out/workspace-audit-runs/20260428T045222Z/commands.tsv`
