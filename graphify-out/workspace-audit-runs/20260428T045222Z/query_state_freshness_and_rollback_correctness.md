```bash
graphify query Trace\ state\ freshness\ across\ discoverPools\,\ warmupStateCache\,\ reloadCacheFromRegistry\,\ StateWatcher\,\ watcher_state_ops\,\ rollbackToBlock\,\ RouteCache\,\ getPathFreshness\,\ and\ simulateHop.\ Rank\ concrete\ stale-state\,\ mixed-time-state\,\ reorg\,\ checkpoint\,\ and\ cache-divergence\ failure\ modes. --budget 800
```
...
NODE normalizePathLimit() [src=src/routing/finder.ts lo
