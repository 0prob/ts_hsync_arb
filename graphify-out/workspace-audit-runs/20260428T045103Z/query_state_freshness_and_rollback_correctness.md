```bash
graphify query Trace\ state\ freshness\ across\ discoverPools\,\ warmupStateCache\,\ reloadCacheFromRegistry\,\ StateWatcher\,\ watcher_state_ops\,\ rollbackToBlock\,\ RouteCache\,\ getPathFreshness\,\ and\ simulateHop.\ Rank\ concrete\ stale-state\,\ mixed-time-state\,\ reorg\,\ checkpoint\,\ and\ cache-divergence\ failure\ modes. --budget 1200
```
...
NODE evaluateCandidatePipeline() [src=src/routing/candidate_pipel
