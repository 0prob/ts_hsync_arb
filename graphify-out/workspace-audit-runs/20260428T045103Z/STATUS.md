...
- WARN `path`: [warmupStateCache() to startMetricsServer()](path_warmupstatecache_to_startmetricsserver.md) status=1
- PASS `path`: [createTopologyService() to enumerateCyclesDual()](path_createtopologyservice_to_enumeratecyclesdual.md)
- WARN `path`: [METRICS_PORT to startMetricsServer()](path_metrics_port_to_startmetricsserver.md) status=1
- WARN `path`: [package.json to runner.ts](path_package_json_to_runner_ts.md) status=1
...
- PASS `explain`: [warmupStateCache()](explain_warmupstatecache.md)
...
- Outputs: `graphify-out/workspace-audit-runs/20260428T045103Z`
- Scope: `graphify-out/workspace-audit-runs/20260428T045103Z/SCOPE.md`
- Commands: `graphify-out/workspace-audit-runs/20260428T045103Z/commands.tsv`
