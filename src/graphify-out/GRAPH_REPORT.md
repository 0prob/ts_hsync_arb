...
## Corpus Check
- 102 files · ~56,382 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 625 nodes · 1196 edges · 27 communities detected
- Extraction: 76% EXTRACTED · 24% INFERRED · 0% AMBIGUOUS · INFERRED: 292 edges (avg confidence: 0.8)
...
- `discoverProtocol()` --calls--> `throttledMap()`  [INFERRED]
  /home/x/t/src/discovery/discover.ts → /home/x/t/src/enrichment/rpc.ts
- `routeKeyFromEdges()` --calls--> `routeIdentityFromEdges()`  [INFERRED]
  /home/x/t/src/routing/finder.ts → /home/x/t/src/routing/route_identity.ts
- `getRoutablePoolContext()` --calls--> `hasZeroAddressToken()`  [INFERRED]
  /home/x/t/src/routing/graph.ts → /home/x/t/src/util/pool_record.ts

## Communities

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (51): getPathFreshness(), assetStmt(), batchUpsertTokenMeta(), getPoolFee(), getTokenDecimals(), getTokenMeta(), upsertPoolFee(), upsertTokenMeta() (+43 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (29): mergeStateIntoCache(), reloadCacheFromRegistry(), throwUnsupportedHypersync(), UnsupportedDecoder, detectReorg(), pick(), buildDiscoveredPoolBatch(), decodeDiscoveryLogs() (+21 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (34): discoverCurveListedFactory(), normalizeBalancerState(), normalizeCurveState(), normalizePoolState(), normalizeV2State(), normalizeV3State(), validatePoolState(), fetchAndNormalizeBalancerPool() (+26 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (35): toFiniteNumber(), enumerateCycles(), enumerateCyclesDual(), enumerateCyclesForToken(), pruneByLiquidity(), sortByLogWeight(), annotatePath(), deduplicatePaths() (+27 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (6): stopMetricsServer(), RegistryMetaCache, loadPoolMetaCache(), RegistryService, CompatDatabase, runValidation()

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (12): clearGasEstimateCache(), RouteCache, routeExecutionCacheKey(), routeIdentityFromEdges(), routeIdentityFromSerializedPath(), buildChunkStateObject(), buildEvaluationChunks(), getStateVersion() (+4 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (35): assessmentNetProfit(), assessRouteResult(), compareAssessmentProfit(), getAssessmentOptimizationOptions(), getOptimizationOptions(), minProfitInTokenUnits(), exp(), getBalancerAmountIn() (+27 more)
...
Cohesion: 0.15
Nodes (10): evaluateCandidatePipeline(), partitionFreshCandidates(), selectOptimizationCandidates(), shouldOptimizeCandidate(), estimateGasCostWei(), gasCostInStartTokenUnits(), rankRoutes(), scoreRoute() (+2 more)
...
- **Why does `RegistryService` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 13`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `mergeCandidateBatch()` connect `Community 3` to `Community 0`, `Community 12`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `recommendGasParams()` connect `Community 8` to `Community 0`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
